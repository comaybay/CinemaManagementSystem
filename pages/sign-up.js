                    ...
                    <div className="login-tab-wrapper">
                      <div className="login-form">
                        <form ng-submit="submit()" className="ng-pristine ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-email">
                          <input placeholder="Họ tên" type="text" value={name} onChange={e => setName(e.target.value)} required="required" className="login first ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" />
                          <div className="flex">
                          ...
                          <input type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} required="required" className="login register-input remove-mb ng-pristine ng-untouched ng-empty ng-valid-email ng-invalid ng-invalid-required" />
                          <div className="row city">
                            <div className="col-md-6 col-sm-6 col-xs-6 first-col"><input type="password" placeholder="Mật khẩu" value={password} onChange={e => setPassword(e.target.value)} required="required" className="login ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" /></div>
                            <div className="col-md-6 col-sm-6 col-xs-6 second-col"><input type="password" placeholder="Xác nhận mật khẩu" value={rePassword} onChange={e => setRePassword(e.target.value)} required="required" className="login ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" />
                            </div>
                          </div>
